...
use App\Modules\Appointments\Events\AppointmentChanged;
use App\Modules\Appointments\Helpers\AppointmentHelper;
...
class AppointmentService
{
    ...
    public function listAppointments(array $filters, Staff $actor): array
    {
        ...
        return AppointmentHelper::formatPaginated($paginator);
    }
    ...
    public function createAppointment(array $data, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'created', $actor);
    ...
    public function updateAppointment(int $id, array $data, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'updated', $actor);
    ...
    public function confirmAppointment(int $id, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'confirmed', $actor);
    ...
    public function cancelAppointment(int $id, array $data, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'cancelled', $actor);
    ...
    public function checkInAppointment(int $id, array $data, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'checked_in', $actor);
    ...
    public function assignDoctor(int $id, array $data, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'doctor_assigned', $actor);
    ...
    public function startAppointment(int $id, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'started', $actor);
    ...
    public function completeAppointment(int $id, array $data, Staff $actor): array
    {
        ...
        $this->broadcastAppointmentChanged($appointment, 'completed', $actor);

        return ['appointment' => $appointment];
    }


    private function broadcastAppointmentChanged(Appointment $appointment,string $action,Staff $actor): void
    {
        $appointment->loadMissing(['patient', 'doctor']);
        AppointmentChanged::dispatch($appointment, $action, $actor);
    }
}
