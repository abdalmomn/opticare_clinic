...
class PermissionList
{
    ...
    const VIEW_OWN_IMAGING_REQUESTS = 'view own imaging requests';

    const CREATE_IMAGING_REQUEST_FOR_PATIENT = 'create imaging request for patient';

    const CONFIRM_IMAGING_PAYMENT = 'confirm imaging payment';

    const SEND_IMAGING_REQUEST_TO_TECHNICIAN = 'send imaging request to technician';

    const START_IMAGING_REQUEST = 'start imaging request';

    const COMPLETE_IMAGING_REQUEST = 'complete imaging request';

    const UPLOAD_DOCTOR_IMAGING_FILES = 'upload doctor imaging files';

    const UPLOAD_EXTERNAL_IMAGING_FILES = 'upload external imaging files';

    const DELETE_OWN_IMAGING_FILE = 'delete own imaging file';

    const DELETE_ANY_IMAGING_FILE = 'delete any imaging file';

    const CANCEL_IMAGING_REQUEST = 'cancel imaging request';

    const VIEW_ALL_IMAGING_REQUESTS = 'view all imaging requests';
